...
public class GoogleGlassDisplay<T extends IData> extends AbstractObserver<T> implements DisplayElement {
	private MessageSupplier<T> messageSupplier;
	public GoogleGlassDisplay(Subject<T> subject,MessageSupplier<T> messageSupplier) {
		super(subject);
