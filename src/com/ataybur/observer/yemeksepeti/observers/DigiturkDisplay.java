...
public class DigiturkDisplay<T extends IData> extends AbstractObserver<T> implements DisplayElement {
	private MessageSupplier<T> messageSupplier;
	public DigiturkDisplay(Subject<T> subject,MessageSupplier<T> messageSupplier) {
		super(subject);
